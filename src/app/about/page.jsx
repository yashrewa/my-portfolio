  ...
  return (
    <>
      ...
      <motion.div variants={variants} initial="hidden" animate="show" className={`h-full pl-6 pr-3 pt-28 md:pt-32 justify-center text-white-50 font-poppins`}>
            ...
            <motion.button variants={top} className={`animate-bounce w-16 h-16 absolute bottom-4 right-0 left-0 m-auto bg-gray-950 rounded-full p-3 flex items-center justify-center`}><Link href='/skills'><AiOutlineDown className='text-4xl text-primary-purple'/></Link></motion.button>
        </motion.div>
      </Pagewrapper>
    </>
  )
