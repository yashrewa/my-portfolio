    ...
    return (
        <motion.div variants={variants} initial='hidden' animate='show' className={`md:z-10 h-full pl-6 pr-3 pt-28 md:pt-10 justify-center text-white-50 font-poppins`}>
            ...
            <motion.div variants={right} className="md:pl-56 flex md:flex-wrap md:gap-y-2 md:h-4/5 md:gap-x-4  md:w-full md:pr-0 md:overflow-hidden md:flex-row md:pt-4 flex-col overflow-y-scroll h-4/5 gap-y-3 pb-2 pr-1">
                ...
                <div className="btn-emboss-plus rounded z-10 bg-gray-950 md:w-96 h-44 pt-2 pb-2 shadow-sm shadow-primary-purple md:pb-0 md:pt-0 md:h-32 flex items-center gap-x-5 pl-2 pr-2">
                ...
                <div className="btn-emboss-plus rounded z-10 bg-gray-950 md:w-96 h-44 pt-2 shadow-sm shadow-primary-purple pb-2 md:pb-0 md:pt-0 md:h-32 flex items-center gap-x-5 pl-2 pr-2">
                ...
                <div className="btn-emboss-plus rounded z-10 bg-gray-950 md:w-96 h-44 pt-2 pb-2 md:pb-0 shadow-sm shadow-primary-purple md:pt-0 md:h-32 flex items-center gap-x-5 pl-2 pr-2">
