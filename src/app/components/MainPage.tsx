...
export const MainPage = () => {
    return (
        <>
            <motion.div variants={variants} initial="hidden" animate="show" className={`index-low h-full px-6 flex items-start flex-col md:pt-64 xl:text-4xl justify-center text-white-50 font-poppins font-black text-5xl md:pl-60 md:text-8xl`}>
                ...
                <motion.div variants={fadeIn} className="z-30 index-low md:index-high tracking-widest text-3xl md:text-7xl pt-2">web <span className="text-aqua-600">d</span>eveloper</motion.div>
                <motion.div variants={fadeIn} className="z-30 index-low md:index-high font-medium text-sm md:text-xl  text-gray-850 pt-2">JavaScript <span className="text-aqua-450">/</span> MERN <span className="text-aqua-450">/</span> NextJs <span className="text-aqua-450">/</span> GraphQl <span className="text-aqua-450">/</span> Typescript <span className="text-aqua-450">/</span> Firebase <span className="text-aqua-450">/</span> Tailwind </motion.div>
